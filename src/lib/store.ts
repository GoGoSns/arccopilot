...
export type View = 'welcome' | 'wallet' | 'send' | 'receive' | 'discover' | 'profile' | 'settings' | 'address-book' | 'address-detail' | 'daily-brief' | 'calendar' | 'gogo-ai' | 'activity' | 'arc-radar' | 'defi-radar' | 'arc-bridge' | 'arc-swap' | 'policy-center' | 'tools'
