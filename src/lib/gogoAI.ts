...
function buildDemoScriptReply(locale: 'en' | 'tr'): GogoResponse {
  const lines = locale === 'tr'
    ? [
        ...
        '2. Portfolio gercek wallet + Gateway bakiyesini okur.',
        '3. who should I tip, butce ve allowlist icinde onerir.',
        '4. x402 demo, 0.001 USDC paid HTTP kaynagini acar.',
        '5. Pay & access olmadan MetaMask imzasi istenmez.',
        '6. Scheduled payments, cron ile uykuda bile tetiklenir.',
        '7. History, ArcScan tx kanitini gosterir.',
        '',
        'Thesis: autonomy without bypass.',
    ...
    : [
        ...
        '2. Portfolio reads real wallet + Gateway balances.',
        '3. who should I tip suggests within budget and allowlist.',
        '4. x402 demo opens a 0.001 USDC paid HTTP resource.',
        '5. No MetaMask signature before Pay & access.',
