...
export const X402_PAYMENT_HISTORY_STORAGE_KEY = 'arccopilot:x402-payment-history'
export const X402_MARKET_AUTOPAY_MODE_STORAGE_KEY = 'arccopilot:x402-market-autopay-mode'
