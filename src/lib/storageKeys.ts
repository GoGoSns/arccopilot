...
export const USER_X_HANDLE = 'arccopilot:user-x-handle'
export const TIP_BUDGET = 'arccopilot:tip-budget'
export const AUTO_TIP_RULE = 'arccopilot:auto-tip-rule'
export const AUTONOMOUS_MODE_ENABLED = 'arccopilot:autonomous-mode-enabled'
export const AGENT_BACKEND_URL = 'arccopilot:agent-backend-url'
export const AGENT_TOKEN = 'arccopilot:agent-token'
export const PAIRING_ACCESS_TOKEN = 'arccopilot:pairing-access-token'
export const PAIRING_REFRESH_TOKEN = 'arccopilot:pairing-refresh-token'
export const PAIRING_USER_ID = 'arccopilot:pairing-user-id'
export const PAIRING_POLICY_AUTONOMOUS_ENABLED = 'arccopilot:pairing-policy-autonomous-enabled'
export const DISMISSED_PATTERNS_KEY = 'arccopilot:patterns:dismissed'
export const AI_PROVIDER_STORAGE_KEY = 'arccopilot:ai-provider'
export const GEMINI_API_KEY_STORAGE_KEY = 'arccopilot:gemini-api-key'
export const OPENAI_API_KEY_STORAGE_KEY = 'arccopilot:openai-api-key'
export const ANTHROPIC_API_KEY_STORAGE_KEY = 'arccopilot:anthropic-api-key'
export const DAILY_BRIEFING_CACHE_STORAGE_KEY = 'arccopilot:daily-briefing-cache'
export const NEWS_FEEDS_STORAGE_KEY = 'arccopilot:news-feeds'
export const NEWS_CACHE_STORAGE_KEY = 'arccopilot:news-cache'
...
export const NOTIF_REMINDERS_STORAGE_KEY = 'arccopilot:notif-reminders'
export const REMINDER_NOTIFIED_STORAGE_KEY = 'arccopilot:reminders:notified'
